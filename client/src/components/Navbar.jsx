...
const Navbar = () => {
  ...
  return (
    <div className='bg-slate-900 rounded-full flex flex-row sm:flex sm:flex-col items-center justify-between w-full sm:space-y-12 px-2 sm:px-0 py-2 sm:w-20 sm:py-8'>
      ...
      <div className='flex sm:flex-end sm:mb-4 ' onClick={handleProfileClick} >
