          ...
          return <div className='left p-5  text-xl sm:text-2xl lg:flex lg:flex-row'>
            ...
            <div>
              ...
              <div className="sm:flex sm:flex-row gap-4 justify-center">
                <button className="bg-gray-700 px-4 py-2 font-semibold rounded-xl m-2"><a href={movie.externalLinks} className='flex flex-row gap-2'> Website <FaLink /> </a></button>
                <button className="bg-gray-700 px-4 py-2 font-semibold rounded-xl m-2"><a href={movie.url}>IMDB</a></button>
                <button className="bg-gray-700 px-4 py-2 font-semibold rounded-xl m-2"><a href={movie.trailer}>Trailer</a></button>
              </div>
            </div>
